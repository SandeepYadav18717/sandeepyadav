...
const skillGroups = [
  {
    ...
    skills: [
      ...
      { name: "Power BI/Matplotlib",          pct: 80, color: "#fb923c" },
      { name: "Feature enginerring",  pct: 78, color: "#facc15" },
      { name: "Pandas",    pct: 84, color: "#4ade80" },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "React ",      pct: 78, color: "#38bdf8" },
      { name: "Fast Api",         pct: 60, color: "#a78bfa" },
  ...
  },
  {
    ...
    icon: "🛠️",
    skills: [
      { name: "Vs code",    pct: 90, color: "#4ade80" },
      { name: "Colab",           pct: 72, color: "#38bdf8" },
      { name: "Claude / AI APIs",  pct: 75, color: "#a78bfa" },
      { name: "Mysql Workbench",    pct: 68, color: "#fb923c" },
      { name: "other",      pct: 88, color: "#f472b6" },
    ],
  },
];
