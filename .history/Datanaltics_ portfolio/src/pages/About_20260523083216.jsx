        ...
        <div className="about-grid">
          <div className="about-card">
            ...
            <p className="about-bio">
                Hi, I'm Sandeep Yadav, a passionate data analyst with a knack for transforming raw data into compelling stories. With a background in Python, SQL, and data visualization, I thrive on uncovering insights that drive informed decisions. When I'm not crunching numbers, you can find me vibing to lofi beats or exploring the latest trends in data science. Let's connect and turn your data into dopamine!      
                Im enthusiastic about collaborating on innovative projects, sharing knowledge, and continuously learning in the ever-evolving world of data. Whether it's building interactive dashboards or diving deep into machine learning, I'm always eager to take on new challenges and make an impact with data. Let's create something amazing together!
                frontend developer with a passion for crafting intuitive user experiences. With a strong foundation in JavaScript and React, I specialize in building dynamic web applications that seamlessly blend form and function. When I'm not coding, you can find me exploring the latest design trends or experimenting with new technologies to stay ahead of the curve. Let's connect and create something extraordinary together!
            </p>
