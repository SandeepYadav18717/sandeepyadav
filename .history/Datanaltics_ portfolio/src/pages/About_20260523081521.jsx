  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: "hidden",
        background:
          "radial-gradient(ellipse at 30% 40%, #0a0e1a 0%, #05070a 100%)",
        display: "flex",
        alignItems: "center",
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              >
                <span className="glitch-text" data-text="SANDEEP">
                  SANDEEP
                </span>
                <span
                  style={{
            ...
            >
              ...
              >
                ...
                {quotes[currentQuote]}
                <span
                  style={{ animation: "blink 1s infinite", marginLeft: "4px" }}
                >
                  |
                </span>
              </p>
            ...
            >
              I'm a <strong style={{ color: "#4ade80" }}>data alchemist</strong>{" "}
              & frontend architect who turns messy datasets into{" "}
              ...
              pure creative energy. Let's make data sexy again. 📈🔥
            </p>
            ...
            >
              <button
                ...
                style={{
                  background:
                    "linear-gradient(105deg, #4ade80 0%, #22c55e 100%)",
                  border: "none",
